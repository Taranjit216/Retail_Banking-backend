...
public class SwaggerConfig {
	...
	private ApiInfo getInfo() {
		...
		return new ApiInfo("Blogging Application : Backend",
				"This project is developed by Taranjit Singh & Pritam Das", "1.0", "Terms of Service",
				new Contact("Durgesh_Mentor", "https://learncodewithdurgesh.com/", "learncodewithdurgesh@gmail.com"),
